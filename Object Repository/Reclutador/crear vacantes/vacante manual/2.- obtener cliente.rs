...
<<<<<<< HEAD:Object Repository/Reclutador/crear vacantes/crear vacante.rs
   <restUrl>https://pre.micros.involverh.com.mx/recruiter/company/${empresa}</restUrl>
=======
   <restUrl>${url}/user/client</restUrl>
>>>>>>> mejoras:Object Repository/Reclutador/crear vacantes/vacante manual/2.- obtener cliente.rs
