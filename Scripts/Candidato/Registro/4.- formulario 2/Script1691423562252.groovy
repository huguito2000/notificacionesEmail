...
WebUI.callTestCase(findTestCase('Candidato/Registro/3.- formulario'), [:], FailureHandling.STOP_ON_FAILURE)
...
WS.sendRequest(findTestObject('candidato/registro/21.- video'))
...
def date() {
    fecha = ['2004-12-12', '2003-12-12', '2002-12-12', '2001-12-12', '2000-12-12', '1999-12-12', '1998-12-12', '1997-12-12'
        , '1996-12-12', '1995-12-12', '1994-12-12', '1993-12-12', '1992-12-12', '1991-12-12', '1990-12-12', '1989-12-12'
        , '1988-12-12', '1987-12-12', '1986-12-12', '1985-12-12', '1984-12-12', '1983-12-12', '1982-12-12', '1981-12-12'
        , '1980-12-12', '1979-12-12', '1978-12-12', '1977-12-12', '1976-12-12', '1975-12-12', '1974-12-12', '1973-12-12'
        , '1972-12-12', '1971-12-12', '1970-12-12', '1969-12-12', '1968-12-12', '1967-12-12', '1966-12-12', '1965-12-12'
        , '1964-12-12', '1963-12-12', '1962-12-12', '1961-12-12', '1960-12-12']
...
def puestos() {
    puesto = ['administrador', 'Contador', 'financiero", "asegurador', 'administrador de negocios', 'programas multidisciplinarios o generales'
        , 'Operador comercial de transporte público', 'Mecánico de vehículos ligeros', 'Mecánico de motocicletas', 'psicologo'
        , 'Sociologo', 'antropologo', 'periodista', 'Criminologo', 'Abogado', 'Ingeniero', 'manufacturero', 'Arquitecto'
        , 'Arquitecto de urbanismo', 'ingeniero civil', 'Ingeniero industrial', 'mecánica', 'electrónica', 'tecnología', 'Electricidad'
        , 'generación de energía', 'Electrónica', 'automatización', 'Ingeniería de vehículos de motor', 'Ingeniero de aeronaves'
        , 'Ingeniero  de mecánica', 'Ingeniero electrónica', 'Ingeniero de tecnología', 'odontologo', 'Medico', 'Agronomo'
        , 'veterinaro', 'Ingeniería mecánica ', 'Ingeniería metalurgia', 'Ingeniería química', 'Filosofo', 'Historiador'
        , 'Físico', 'Químico', 'Matemático', 'estadístico', 'Docente', 'Docente para educación básica', 'Docente nivel preescolar'
        , 'Biologo', 'bioquímico', 'pescador', 'ganadero', 'Maquinista naval', 'Astrónomo', 'Biotecnólogo', 'Químico industrial'
        , 'Ingeniero bioquímico', 'Ingeniero nuclear', 'Toxicólogo', 'Creativo publicitario', 'Operador de cámara', 'Community manager'
        , 'Documentalista de radio y televisión', 'Presentador de radio y televisión', 'Vigilante de seguridad', 'Instructor de fitness'
        , 'Profesor de yoga', 'Nutricionista', 'Terapeuta deportivo', 'Diseñador de páginas web', 'Asistente de diseñador'
        , 'Diseñador de moda', 'Diseñador gráfico', 'Técnico en reprografía', 'Rotulista']
