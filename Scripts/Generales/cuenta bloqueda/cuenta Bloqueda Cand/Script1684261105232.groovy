...
while (statusCode != 412) {
    response = WS.sendRequest(findTestObject('Generales/Cuenta Bloqueada/cuenta Bloqueda Cand'))
...
WS.verifyResponseStatusCode(response, 412)

response = WS.sendRequest(findTestObject('Generales/Cuenta Bloqueada/new pass Cand'))
...
WebUI.takeScreenshot('/Users/huguito/Desktop/notificaciones/Generales/EmailBloqueadoCand.png')
