...
while (statusCode != 412) {
	response = WS.sendRequest(findTestObject('Generales/Cuenta Bloqueada/cuenta Bloqueda Reclu'))
...
response = WS.sendRequest(findTestObject('Generales/Cuenta Bloqueada/new pass Reclu'))
...
WebUI.takeScreenshot('/Users/huguito/Desktop/notificaciones/Generales/EmailBloqueado.png')
