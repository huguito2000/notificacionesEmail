...
email = (('invitado' + now) + '@yopmail.com')

GlobalVariable.email = email

println(email)

response = WS.sendRequest(findTestObject('Reclutador/registro/invitacion team'))
...
WebUI.takeScreenshot('/Users/huguito/Desktop/notificaciones/Reclutador/invitacionTeam.png')
