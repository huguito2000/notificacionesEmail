...
response = WS.sendRequest(findTestObject('Reclutador/vacantes/vacante team/vacante Team'))
...
WebUI.setText(findTestObject('Generales/Cuenta Bloqueada/Campo Email'), 'hugo.invitado')

WebUI.sendKeys(findTestObject('Generales/Cuenta Bloqueada/Campo Email'), Keys.chord(Keys.ENTER))

WebUI.takeScreenshot('/Users/huguito/Desktop/notificaciones/Reclutador/vacanteTeam.png')
